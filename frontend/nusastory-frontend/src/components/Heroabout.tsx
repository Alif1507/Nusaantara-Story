  ...
  return (
    <div className='min-h-screen pt-20 md:pt-0'>
      <div className='min-h-screen flex flex-col md:flex-row justify-center items-center relative px-4 md:px-0'>
        <img src="/gambar/gambar-about-hero.png" alt="" className="w-full max-w-[400px] md:max-w-none" />
        <h1 style={{ fontFamily: "Inkut Antiqua, serif" }} className='text-[40px] md:text-[65px] text-[#A02F1F] text-center md:text-left md:absolute md:top-45 md:right-98'>Membuat Cerita</h1>
